...
# Supporting object detection class provided by Microsoft
class ObjectDetection(object):
    ...
    def __init__(self, labels, prob_threshold=0.50, max_detections = 4):
    ...
    def preprocess(self, image):
        ...
        #Workaround to avoid mscviplib. Manual ajustment of the image values.
